...
INSERT INTO `citas` (`id`, `fecha`, `hora`, `consultorio`, `doctor_id`, `paciente_id`) VALUES
	(1, '2024-02-14', '06:12:00', 413, 1, 1),
	(2, '2025-02-14', '11:00:00', 414, 2, 2),
	(5, '2024-03-14', '12:10:00', 415, 1, 2);
...
INSERT INTO `pacientes` (`nombre`, `apellidos`, `n_documento`, `celular`, `id`) VALUES
	('Harry', 'Garcia', 1213233434, 12121212, 1),
	('Nestor ', 'Montenegro', 23233443445, 12212121212, 2);
